/* Reused class from my programming assignment 3 */
package controllers;
...
1. calculate the members BMI.
2. calculate the BMI category the member falls into.
3. calculate if a memebers weight is ideal or not
*/
public class GymUtility {
   ...
   */
  public static String determineBMICategory(Member member, Assessment assessment) {

    double bmiValue = calculateBMI(member, assessment);
...
//   if the member is male an ideal body weight is 50kg plus 2.3kg for every inch over 5ft
      if (gender.equalsIgnoreCase("m")) {
        ...
        idealWeight = (int) (idealWeight * 100) / 100.0;
      }
